...
$CONFIG = '{"lang":"ro","error_reporting":false,"show_hidden":true,"hide_Cols":false,"theme":"dark"}';
/**
...
//Application Title
define('APP_TITLE', 'Castel Mimi Wine Resort');
...
$auth_users = array(
    'admin' => '$2y$10$xe3TP1PCkxU3/A5RQqJm1.vcAbxKy3KK8UuO3fVLFT0u8HFmg/JNS', 
...
$favicon_path = 'https://castelmimi.md/wp-content/uploads/2023/05/cropped-favicon-32x32.png';
...
// Default language
$lang = isset($cfg->data['lang']) ? $cfg->data['lang'] : 'ro';
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            ...
                                            <img src="../img/logo1.png" alt="Logo" height='100%' style='margin-bottom:20px;'>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://castelmimi.md" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Reutilizat de Castel Mimi Wine Resort</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<?php
    ...
    function lng($txt)
    {
        global $lang;
        // Romanian Language
$tr['ro']['AppName']        = 'Castel Mimi Wine Resort';
$tr['ro']['AppTitle']       = 'Castel Mimi Wine Resort Editor';
$tr['ro']['Login']          = 'Autentificare';
$tr['ro']['Username']       = 'Nume utilizator';
$tr['ro']['Password']       = 'Parolă';
$tr['ro']['Logout']         = 'Deconectare';
$tr['ro']['Move']           = 'Mutare';
$tr['ro']['Copy']           = 'Copiere';
$tr['ro']['Save']           = 'Salvare';
$tr['ro']['SelectAll']      = 'Selectează tot';
$tr['ro']['UnSelectAll']    = 'Deselectează tot';
$tr['ro']['File']           = 'Fișier';
$tr['ro']['Back']           = 'Înapoi';
$tr['ro']['Size']           = 'Dimensiune';
$tr['ro']['Perms']          = 'Permisiuni';
$tr['ro']['Modified']       = 'Modificat';
$tr['ro']['Owner']          = 'Proprietar';
$tr['ro']['Search']         = 'Căutare';
$tr['ro']['NewItem']        = 'Element Nou';
$tr['ro']['Folder']         = 'Dosar';
$tr['ro']['Delete']         = 'Ștergere';
$tr['ro']['Rename']         = 'Redenumire';
$tr['ro']['CopyTo']         = 'Copiază în';
$tr['ro']['DirectLink']     = 'Link direct';
$tr['ro']['UploadingFiles'] = 'Încărcare Fișiere';
$tr['ro']['ChangePermissions'] = 'Schimbă Permisiuni';
$tr['ro']['Copying']        = 'Copiere';
$tr['ro']['CreateNewItem']  = 'Crează Element Nou';
$tr['ro']['Name']           = 'Nume';
$tr['ro']['AdvancedEditor'] = 'Editor Avansat';
$tr['ro']['Actions']        = 'Acțiuni';
$tr['ro']['Folder is empty'] = 'Dosarul este gol';
$tr['ro']['Upload']         = 'Încărcare';
$tr['ro']['Cancel']         = 'Anulare';
$tr['ro']['InvertSelection'] = 'Inversează Selecția';
$tr['ro']['DestinationFolder'] = 'Dosar Destinație';
$tr['ro']['ItemType']       = 'Tip Element';
$tr['ro']['ItemName']       = 'Nume Element';
$tr['ro']['CreateNow']      = 'Creează Acum';
$tr['ro']['Download']       = 'Descărcare';
$tr['ro']['Open']           = 'Deschide';
$tr['ro']['UnZip']          = 'Dezarhivează';
$tr['ro']['UnZipToFolder']  = 'Dezarhivează în dosar';
$tr['ro']['Edit']           = 'Editare';
$tr['ro']['NormalEditor']   = 'Editor Normal';
$tr['ro']['BackUp']         = 'Copie de Rezervă';
$tr['ro']['SourceFolder']   = 'Dosar Sursă';
$tr['ro']['Files']          = 'Fișiere';
$tr['ro']['Change']         = 'Schimbare';
$tr['ro']['Settings']       = 'Setări';
$tr['ro']['Language']       = 'Limbă';
$tr['ro']['ErrorReporting'] = 'Raportare Erori';
$tr['ro']['ShowHiddenFiles'] = 'Arată Fișiere Ascunse';
$tr['ro']['Help']           = 'Ajutor';
$tr['ro']['Created']        = 'Creat';
$tr['ro']['Help Documents'] = 'Documente de Ajutor';
$tr['ro']['Report Issue']   = 'Raportează Problema';
$tr['ro']['Generate']       = 'Generează';
$tr['ro']['FullSize']       = 'Dimensiune Completă';
$tr['ro']['HideColumns']    = 'Ascunde coloanele Permisiuni/Proprietar';
$tr['ro']['You are logged in'] = 'Ești autentificat';
$tr['ro']['Nothing selected']  = 'Nimic selectat';
$tr['ro']['Paths must be not equal'] = 'Căile nu trebuie să fie identice';
$tr['ro']['Renamed from']       = 'Redenumit din';
$tr['ro']['Archive not unpacked'] = 'Arhiva nu a fost dezarhivată';
$tr['ro']['Deleted']            = 'Șters';
$tr['ro']['Archive not created'] = 'Arhiva nu a fost creată';
$tr['ro']['Copied from']        = 'Copiat din';
$tr['ro']['Permissions changed'] = 'Permisiuni schimbate';
$tr['ro']['to']                 = 'în';
$tr['ro']['Saved Successfully'] = 'Salvat cu succes';
$tr['ro']['not found!']         = 'nu a fost găsit!';
$tr['ro']['File Saved Successfully'] = 'Fișier salvat cu succes';
$tr['ro']['Archive']            = 'Arhivă';
$tr['ro']['Permissions not changed'] = 'Permisiuni neschimbate';
$tr['ro']['Select folder']      = 'Selectează dosar';
$tr['ro']['Source path not defined'] = 'Calea sursă nu este definită';
$tr['ro']['already exists']     = 'există deja';
$tr['ro']['Error while moving from'] = 'Eroare la mutarea din';
$tr['ro']['Create archive?']    = 'Creezi arhivă?';
$tr['ro']['Invalid file or folder name'] = 'Nume de fișier sau dosar invalid';
$tr['ro']['Archive unpacked']   = 'Arhivă dezarhivată';
$tr['ro']['File extension is not allowed'] = 'Extensia fișierului nu este permisă';
$tr['ro']['Root path']          = 'Cale rădăcină';
$tr['ro']['Error while renaming from'] = 'Eroare la redenumirea din';
$tr['ro']['File not found']     = 'Fișierul nu a fost găsit';
$tr['ro']['Error while deleting items'] = 'Eroare la ștergerea elementelor';
$tr['ro']['Moved from']         = 'Mutat din';
$tr['ro']['Generate new password hash'] = 'Generează hash nou pentru parolă';
$tr['ro']['Login failed. Invalid username or password'] = 'Autentificare eșuată. Nume de utilizator sau parolă invalidă';
$tr['ro']['password_hash not supported, Upgrade PHP version'] = 'password_hash nu este suportat, actualizează versiunea PHP';
$tr['ro']['Advanced Search']    = 'Căutare Avansată';
$tr['ro']['Error while copying from'] = 'Eroare la copierea din';
$tr['ro']['Invalid characters in file name'] = 'Caractere invalide în numele fișierului';
$tr['ro']['FILE EXTENSION HAS NOT SUPPORTED'] = 'EXTENSIA FIȘIERULUI NU ESTE SUPORTATĂ';
$tr['ro']['Selected files and folder deleted'] = 'Fișierele și dosarele selectate au fost șterse';
$tr['ro']['Error while fetching archive info'] = 'Eroare la obținerea informațiilor despre arhivă';
$tr['ro']['Delete selected files and folders?'] = 'Ștergi fișierele și dosarele selectate?';
$tr['ro']['Search file in folder and subfolders...'] = 'Caută fișier în dosar și subdosare...';
$tr['ro']['Access denied. IP restriction applicable'] = 'Acces refuzat. Restricție IP aplicabilă';
$tr['ro']['Invalid characters in file or folder name'] = 'Caractere invalide în numele fișierului sau dosarului';
$tr['ro']['Operations with archives are not available'] = 'Operațiunile cu arhive nu sunt disponibile';
$tr['ro']['File or folder with this path already exists'] = 'Fișierul sau dosarul cu această cale există deja';
$tr['ro']['Are you sure want to rename?'] = 'Ești sigur că vrei să redenumești?';
$tr['ro']['Are you sure want to'] = 'Ești sigur că vrei să';
$tr['ro']['Date Modified']      = 'Data Modificării';
$tr['ro']['File size']          = 'Dimensiune fișier';
$tr['ro']['MIME-type']          = 'Tip MIME';

        // English Language
        $tr['en']['AppName']        = 'Castel Mimi Wine Resort';
        $tr['en']['AppTitle']       = 'Castel Mimi Wine Resort Editor';
        $tr['en']['Login']          = 'Sign in';
